...
namespace TeleSpecialists
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, string>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser, ApplicationRole, string, IdentityUserLogin, MyUserRole, IdentityUserClaim>(context.Get<ApplicationDbContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
        ...
        {
            var manager = new ApplicationRoleManager(new RoleStore<ApplicationRole, string, MyUserRole>(context.Get<ApplicationDbContext>()));
            return manager;
        }
    }
}
