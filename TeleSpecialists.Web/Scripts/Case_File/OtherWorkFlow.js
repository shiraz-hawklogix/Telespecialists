...
function checktimefirst() {
    if ($(".timeFirst").is(':checked')) {
        $('.childtimefirst').show();
    }
    else {
        $('.childtimefirst').hide();
...
function checkVideotimefirst() {
    if ($(".videostart").is(':checked')) {
        $('.childVideoStrt').show();
    }
    else {
        $('.childVideoStrt').hide();
...
function checkNeedleTime() {
    if ($(".needleTime").is(':checked')) {
        $('.childarrivalneedle').show();
    }
    else {
        $('.childarrivalneedle').hide();
    }
    if ($("#4").is(':checked')) {
        $('.childdelaysimaging').show(200);
        if ($("#40").is(':checked')) {
