...
namespace TeleSpecialists.BLL.Model
{
    ...
    public partial class @case
    {
        ...
        public string cas_caller_source_key_title { get; set; }

        public string cas_metric_stamp_time_formated { get; set; }

        public string cas_identification_Title { get; set; }

        public CaseInterval CaseInterval { get; set; }

        public string cas_cart_location_key_Title { get; set; } 
    ...
    public class CaseInterval
    {
        ...
        private readonly ICollection<case_assign_history> case_Assign_History;
        public CaseInterval(@case cas)
        {
            if (cas != null)
            {
                start_time = cas.cas_response_ts_notification ?? null;
                stamp_time_est = cas.cas_metric_stamp_time_est ?? null;
                stamp_time = cas.cas_metric_stamp_time ?? null;
                login_time = cas.cas_response_first_atempt ?? null;
                door_time_est = cas.cas_metric_door_time_est ?? null;
                door_time = cas.cas_metric_door_time ?? null;
                needle_time = cas.cas_metric_needle_time_est ?? null;
                callback_time = cas.cas_callback_response_time_est ?? null;
                case_Assign_History = cas.case_assign_history;
            }
            else
            {
    ...
    public class caseMetaData
    {
        ...
        public int cas_fac_key { get; set; }
        ...
        public int cas_identification_type { get; set; }
        ...
        public string cas_patient_type { get; set; }

        [Display(Name = "tPA Candidate:")]
        public string cas_metric_tpa_consult { get; set; }
        ...
        public bool cas_metric_last_seen_normal { get; set; }

        [Display(Name = "History of Hemorrhagic Complications or Intracranial Hemorrhage")]
        public bool cas_metric_has_hemorrhgic_history { get; set; }

        [Display(Name = "Recent Anticoagulants")]
        public bool cas_metric_has_recent_anticoagulants { get; set; }

        [Display(Name = "History of Recent Major Surgery")]
        public bool cas_metric_has_major_surgery_history { get; set; }

        [Display(Name = "History of Recent Stroke")]
        public bool cas_metric_has_stroke_history { get; set; }
