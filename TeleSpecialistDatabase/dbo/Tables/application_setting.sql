CREATE TABLE [dbo].[application_setting] (
    ...
    [aps_session_timeout_in_minutes]                       BIGINT           NULL,
    [aps_two_factor_code_expiry_timeout_in_minutes]        BIGINT           NULL,
    [aps_enable_logout_from_other_devices]                 BIT              DEFAULT ((1)) NOT NULL,
    [aps_enable_pending_cases_notifications]               BIT              DEFAULT ((1)) NOT NULL,
