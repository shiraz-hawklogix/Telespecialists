CREATE TABLE [dbo].[user_schedule_sleep] (
    ...
    [uss_is_active]        BIT             CONSTRAINT [DF_user_schedule_sleep_rsr_is_active] DEFAULT ((1)) NULL,
    [uss_created_by]       NVARCHAR (128)  NOT NULL,
    [uss_created_by_name]  VARCHAR (300)   NULL,
    [uss_created_date]     DATETIME        CONSTRAINT [DF_user_schedule_sleep_uss_created_date] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [PK_user_schedule_sleep] PRIMARY KEY CLUSTERED ([uss_key] ASC),
    CONSTRAINT [FK_user_schedule_sleep_AspNetUsers] FOREIGN KEY ([uss_user_id]) REFERENCES [dbo].[AspNetUsers] ([Id])
);


GO
ALTER TABLE [dbo].[user_schedule_sleep] NOCHECK CONSTRAINT [FK_user_schedule_sleep_AspNetUsers];
