...
GO
ALTER TABLE [dbo].[nih_stroke_scale_answer] NOCHECK CONSTRAINT [FK_nih_stroke_scale_answer_case];


GO
ALTER TABLE [dbo].[nih_stroke_scale_answer] NOCHECK CONSTRAINT [FK_nih_stroke_scale_answer_entity_type];


GO
ALTER TABLE [dbo].[nih_stroke_scale_answer] NOCHECK CONSTRAINT [FK_nih_stroke_scale_answer_nih_stroke_scale_question];
