CREATE TABLE [dbo].[facility] (
    ...
    [fac_description]                  VARCHAR (MAX)    NULL,
    ...
    [qps_number]                       NVARCHAR (150)   NULL,
    [fac_emr]                          NVARCHAR (MAX)   NULL,
    [fac_is_pac]                       BIT              DEFAULT ((0)) NOT NULL,
    ...
    [fac_cst_key_with_Name]            NVARCHAR (100)   NULL,
    [IsSleep]                          BIT              CONSTRAINT [Con_isSleep] DEFAULT ('false') NOT NULL,
    [fac_ts_account_ID]                VARCHAR (MAX)    NULL,
    [fac_ai_software_ddl]              INT              NULL,
