CREATE TABLE [dbo].[case_template_stroke_neuro_tpa] (
    ...
    [csn_critical_care_minutes]        INT            NULL,
    [csn_family_consent_available]     BIT            NULL,
    [csn_PMH]                          VARCHAR (50)   NULL,
    [csn_anticoagulant_use]            BIT            NULL,
    [csn_anticoagulant_use_text]       VARCHAR (MAX)  NULL,
    [csn_antiplatelet_use]             BIT            NULL,
    [csn_antiplatelet_use_text]        VARCHAR (MAX)  NULL,
    [csn_NIHSS_comatose]               INT            NULL,
    [csn_NIHSS_comatose_text]          VARCHAR (MAX)  NULL,
